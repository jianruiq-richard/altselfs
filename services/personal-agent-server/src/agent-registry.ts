  ...
  return [
    ...
    },
    {
      ...
      capabilities: [
        ...
        'Prioritize enabled information-source teammates such as Instagram Looter, TikTok API23, YouTube V2, Similarweb API1, Semrush13, Semrush8, Ahrefs URL Research, Domain Metrics Check, and future Google, X/Twitter, and Facebook sources',
      ...
      tools: [
        ...
        'altselfs_x_competitor_activity_when_twitter241_employee_enabled',
        'altselfs_tiktok_api23_when_tiktok_api23_employee_enabled',
        'altselfs_youtube_competitor_activity_when_youtube_v2_employee_enabled',
        ...
        'future_google_facebook_sources_when_enabled',
      ],
      riskLevel: 'medium',
      requiresWorkspace: false,
