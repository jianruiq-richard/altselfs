        ...
        tools: [
          {
            name: TOOL_NAME,
            description:
              'Delegate an objective-level execution, research, private-data, competitive-intelligence, artifact, or tool-use step to the thread-bound Codex agent. Codex uses its native app-server session and chooses the execution path. Hermes should provide the objective, constraints, relevant context, and acceptance criteria; Codex returns results to Hermes, and Hermes decides the final user reply.',
            inputSchema: {
              type: 'object',
              properties: {
                task: {
                ...
                hermesContext: {
                  type: 'string',
                  description:
                    'Optional Hermes-only background Codex needs for this task. Keep it focused. Include only relevant facts, prior verified tool results, user constraints, or artifact references.',
                },
              },
              required: ['task'],
