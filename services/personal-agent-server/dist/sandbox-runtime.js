...
export function resolveRuntimePaths(config, request, runId) {
...
export async function readSandboxState(paths) {
    if (!paths.statePath)
        return null;
    try {
...
export async function writeSandboxState(paths, patch) {
    if (!paths.statePath)
        return;
...
export async function calculateDirectoryBytes(root) {
    try {
...
async function calculateDirectoryBytesInner(root) {
