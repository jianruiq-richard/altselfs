...
export function AnalyticsConsent() {
  ...
  return (
    <section aria-label="Cookie preferences" className="fixed inset-x-3 bottom-3 z-[100] mx-auto max-w-2xl rounded-2xl border border-white/15 bg-zinc-950 p-5 text-sm text-zinc-300 shadow-2xl">
      ...
      <p className="mt-2 leading-relaxed">We use optional cookies to understand product usage and measure our ads. You can allow analytics only, include advertising measurement, or decline. Change your choice anytime. <Link href="/privacy#cookies" className="underline underline-offset-2">Privacy policy</Link></p>
