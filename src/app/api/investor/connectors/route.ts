...
const PERSONAL_CONNECTORS = [
  ...
  },
  {
    ...
    description: 'message Meta accounts, Instagram message Facebook Page message.',
...
const COMPETITIVE_CONNECTORS = [
  ...
  },
  {
    key: 'semrush8',
    label: 'Semrush8',
    description: 'message SEO rank, message, message, message URL traffic.',
    dbProvider: 'SEMRUSH8',
  },
  {
    key: 'domain_metrics_check',
    label: 'Domain Metrics Check',
    description: 'DA/PA, Spam Score, Trust Flow, DR, message.',
