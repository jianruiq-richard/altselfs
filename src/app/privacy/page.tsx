  ...
  return (
    ...
    >
      ...
      <section id="cookies">
        ...
        <p>
          Analytics and advertising measurement are enabled by default unless you previously saved a different preference in this browser. There is no in-site cookie preference panel. You can use your browser&apos;s cookie and tracking controls, although these controls may not block all server-side measurement. Clearing this site&apos;s stored data removes any saved preference and restores the default settings. Analytics can include Google Analytics and privacy-masked session replay. With advertising measurement enabled, we use Google Analytics to relate ad visits to registration, task completion, and purchases. We may associate these events with an internal account identifier; we do not send your email address or private task content in these events.
        </p>
        <p>
