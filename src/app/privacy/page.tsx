  ...
  return (
    ...
    >
      ...
      <section id="cookies">
        ...
        <p>
          Analytics and advertising measurement are enabled by default unless you have saved a different preference. Use Cookie preferences to disable either or both, or change your choice later. Your saved preference applies to this browser. Analytics can include Google Analytics and privacy-masked session replay. With advertising measurement enabled, we use Google Analytics to relate ad visits to registration, task completion, and purchases. We may associate these events with an internal account identifier; we do not send your email address or private task content in these events.
        </p>
        <p>
